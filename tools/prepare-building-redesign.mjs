...
const frames=await page.evaluate(async ({b64,name})=>{
 ...
 const sw=Math.floor(img.width/5),cells=[]; const rows=({lumbermill:[0,280,590,860,1122],refinery:[0,290,620,860,1122],magetower:[0,310,650,890,1122],oilrig:[0,295,690,900,1122],stables:[0,300,640,870,1122],foundry:[0,280,590,850,1122]})[name] ?? [0,img.height/4,img.height/2,img.height*3/4,img.height];
