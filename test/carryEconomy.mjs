...
for(const [resource,tile,expected] of [['gold',4,100],['lumber',3,50]]){
 ...
 w.map.set(15,12,tile);w.map.amount[w.map.idx(15,12)]=resource==='gold'?1000:40;
...
console.log('PASS: 100 gold, 50 wood across two trees, exact deposits, playable founding budget.');
